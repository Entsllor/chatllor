...
@pytest.mark.asyncio
async def test_failed_delete_message_if_not_found(default_user, chat_with_default_user, client, auth_header):
    response = await client.delete(
...
@pytest.mark.asyncio
async def test_failed_delete_foreign_message_from_chat(second_user, chat_with_default_user, client, auth_header):
...
@pytest.mark.asyncio
async def test_read_messages(client, auth_header, chat_with_default_user, second_user, default_user):
...
@pytest.mark.asyncio
async def test_failed_read_messages_user_not_in_chat(client, auth_header, empty_chat, second_user, default_user):
