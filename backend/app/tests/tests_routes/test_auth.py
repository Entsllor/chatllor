...
@pytest.mark.asyncio
async def test_registration_with_valid_data(client, urls):
...
@pytest.mark.asyncio
async def test_failed_registration_if_no_email(client, urls):
...
@pytest.mark.asyncio
async def test_failed_registration_if_no_password(client, urls):
...
@pytest.mark.asyncio
async def test_failed_registration_if_no_username(client, urls):
...
@pytest.mark.asyncio
async def test_failed_registration_if_not_unique_username(default_user, client, urls):
...
@pytest.mark.asyncio
async def test_login(default_user, client, urls):
...
@pytest.mark.asyncio
async def test_failed_login_wrong_password(default_user, client, urls):
    response = await client.post(
        urls.login_by_password,
...
@pytest.mark.asyncio
async def test_failed_login_user_does_not_exist(default_user, client, urls):
    response = await client.post(
        urls.login_by_password,
...
@pytest.mark.asyncio
async def test_revoke_tokens(client, urls, token_pair):
...
@pytest.mark.asyncio
async def test_failed_revoking_token_if_refresh_token_expired(client, urls, token_pair, default_user):
...
@pytest.mark.asyncio
async def test_failed_revoking_token_if_invalid_access_token(client, urls, token_pair):
...
@pytest.mark.asyncio
async def test_failed_revoking_token_if_access_token_belongs_to_another_user(client, urls, token_pair, second_user):
...
@pytest.mark.asyncio
async def test_get_private_user_data(client, urls, auth_header):
...
@pytest.mark.asyncio
async def test_failed_get_private_user_data_invalid_token(client, urls, auth_header):
...
@pytest.mark.asyncio
async def test_failed_get_private_user_data_expired_token(client, urls, default_user):
...
@pytest.mark.asyncio
async def test_failed_get_private_user_data_without_token(client, urls, token_pair):
...
@pytest.mark.asyncio
async def test_logout(client, urls, token_pair):
